...
public class BranchLengthAveragingTaxonomyCollapsingStrategyTest {
  ...
  public void mergeTwoNodesTest() {
    testCollapse("(s1.1:4,(s2.1:2,s3.1:1,s5.1:1):4,s4.1:2)root;", "(s1.1:4,(s5.1:1,T1.2 (2):1.5):4,s4.1:2)root;");
  }

  @Test
  public void mergeTwoNodesAndCollapseTest() {
    testCollapse("(s1.1:4,(s2.1:2,s3.1:1):4,s4.1:2)root;", "(s1.1:4,s4.1:2,T1.2 (2):5.5)root;");
  }
